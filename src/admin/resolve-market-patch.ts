...
/**
 * Admin Script: Resolve Market (Patch Version)
 * Resolves a prediction market on Sui using market::resolve_market (V12)
 * Uses simplified API without explicit resolver address parameter
 */
